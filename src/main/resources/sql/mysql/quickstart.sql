...
-- bible --
insert into tb_book(id, title, abbr, part) values(1, '约翰福音', '约', '2');

insert into tb_chapter(id, book_id, num, contain_join_verse) values(1, 1, 1, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(2, 1, 2, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(3, 1, 3, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(4, 1, 4, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(5, 1, 5, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(6, 1, 6, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(7, 1, 7, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(8, 1, 8, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(9, 1, 9, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(10, 1, 10, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(11, 1, 11, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(12, 1, 12, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(13, 1, 13, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(14, 1, 14, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(15, 1, 15, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(16, 1, 16, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(17, 1, 17, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(18, 1, 18, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(19, 1, 19, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(20, 1, 20, false);
insert into tb_chapter(id, book_id, num, contain_join_verse) values(21, 1, 21, false);

insert into tb_paragraph(id, chapter_id, title, subtitle, type) values(1, 1, '道成肉身', null, 'p');
insert into tb_paragraph(id, chapter_id, title, subtitle, type) values(2, 1, '施洗约翰的见证', '（太3·1—12；可1·1—8；路3·1—18）', 'p');
insert into tb_paragraph(id, chapter_id, title, subtitle, type) values(3, 1, '　神的羔羊', null, 'p');
insert into tb_paragraph(id, chapter_id, title, subtitle, type) values(4, 1, '初次选召门徒', null, 'p');
insert into tb_paragraph(id, chapter_id, title, subtitle, type) values(5, 1, '呼召腓力和拿但业', null, 'p');
...
insert into tb_token(id, book_id, chapter_id, name) values (1, 1, 1, '约 1:1-2');
insert into tb_token(id, book_id, chapter_id, name) values (2, 1, 1, '约 1:9');
